...
class Slides extends CI_Controller
{
    ...
    public function update($id, $oldFileName){
        ...
        if($validate){
            ...
            if($_FILES["img_url"]["name"] !== "") {
                ...
                $image_1920x650 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",1920,650, $file_name);
                $deleteImage = unlink("uploads/$this->viewFolder/1920X650/$oldFileName");
                if($image_1920x650 && $deleteImage){
    ...
    public function delete($id, $file_name){
        ...
        $deleteImage = unlink("uploads/$this->viewFolder/1920X650/$file_name");
        // TODO Alert Sistemi Eklenecek...
