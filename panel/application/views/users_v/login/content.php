...
<div class="simple-page-wrap">
    ...
    <div class="simple-page-form animated flipInY" id="login-form">
        <h4 class="form-title m-b-xl text-center">Bilgilerinizle CMS'e giriş yapınız.</h4>
        <form action="<?php echo base_url("userop/do_login"); ?>" method="post">
            ...
            <div class="form-group">
                <input id="sign-in-password" type="password" class="form-control" placeholder="Şifrenizi giriniz" name="user_password">
                <?php if(isset($form_error)){ ?>
