<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            <?php echo "<b>$item->user_name</b> adlı kullanıcıyı düzenliyorsunuz"; ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
                ...
                <form action="<?php echo base_url("users/update/$item->id"); ?>" method="post" >
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control" placeholder="E-mail Adresi" name="email" value="<?php echo isset($form_error) ? set_value("email") : "$item->email"; ?>">
                        <?php if(isset($form_error)){ ?>
