                        ...
                        <?php foreach($items as $item) { ?>
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center w300">
                                    ...
                                    <a href="<?php echo base_url("portfolio/update_form/$item->id"); ?>" class="btn btn-xs btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a>
                                    <a href="<?php echo base_url("portfolio/image_form/$item->id"); ?>" class="btn btn-xs btn-dark btn-outline"><i class="fa fa-image"></i> Resimler</a>
                                </td>
                            </tr>
